...
<template>
        <div class="container Package_Box">
            <h3>Search and book your favourite package tour here!</h3>
            <div class="row">
                <div class="col-md-7 First-Section">

                    <p>Enter Destination Name Or Package</p>
...
@media screen and (max-width: 768px) {
    .Package_Box h3 , .First-Section h4 , .Second-Section h4{
